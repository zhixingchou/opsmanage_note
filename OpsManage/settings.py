...
REDSI_KWARGS_LPUSH = {"host":'127.0.0.1','port':6379,'db':1}
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ["/opt/OpsManage/OpsManage/static/",'/opt/OpsManage/OpsManage/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
...
STATIC_URL = '/static/'
STATICFILES_DIRS = (
     '/opt/OpsManage/OpsManage/static/',
    )
#TEMPLATE_DIRS = (
##     os.path.join(BASE_DIR,'mysite\templates'),
#    '/opt/OpsManage/OpsManage/templates/',
#)
